...
return (
    <Box w='80%' m='auto' pt={10}>
      <Text color='red'>Special Category</Text>
        ...
        <hr />
        <Text w='40%' m='auto' pb={10}>Bring your dreams to life with our Custom Creations category. Collaborate with our artisans to design bespoke jewelry that reflects your unique style</Text>
